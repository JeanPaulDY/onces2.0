...
class AcercaDeFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        btm.setOnNavigationItemReselectedListener {
            when(it.itemId){
                R.id.homebar -> findNavController().navigate(R.id.action_acerca_DeFragment_to_homeFragment)
                R.id.perfilbar -> findNavController().navigate(R.id.action_acerca_DeFragment_to_perfilFragment)
                R.id.carritobar -> findNavController().navigate(R.id.action_acerca_DeFragment_to_comprasFragment)
                R.id.mapabar -> findNavController().navigate(R.id.action_acerca_DeFragment_to_ruta_PedidosFragment)
                R.id.cerrarsesion->{
                    firebaseAuth.signOut()
                    findNavController().navigate(R.id.action_acerca_DeFragment_to_loginActivity)
                    true
                }
            }
        }
